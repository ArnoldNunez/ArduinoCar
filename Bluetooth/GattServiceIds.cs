...
namespace ArduinoCar.Bluetooth
{
    ...
    {
        /// <summary>
        /// The backing store for teh list of services
        /// </summary>
        private readonly IReadOnlyCollection<GattService> _collection;
        ...
        {
            _collection = new List<GattService>(new[]
            {
                ...
                new GattService("BTE16", "IDENTIFIER HERE", 0xFFE0, "GSS")
            });
        }
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerator<GattService> GetEnumerator() => _collection.GetEnumerator();
